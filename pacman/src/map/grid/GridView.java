...
public class GridView extends JPanel implements PropertyChangeListener {
	...
	/**
	 * Creates a src.grid panel.
	 * @param guiInformation Information from the GUI that the src.grid requires.
	 ...
	 * @param position The tile's position in the src.grid.
	 */
